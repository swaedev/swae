...
private var lockQueue = DispatchQueue(label: "com.eerimoq.Swae.SampleBufferReceiver")
...
class SampleBufferReceiver {
    ...
    private func readPointer(_ senderFd: Int32, _ pointer: UnsafeMutableRawPointer, _ count: Int)
        throws
    {
        var offset = 0
        while offset < count {
