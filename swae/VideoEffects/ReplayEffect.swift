...
private let replayImagesQueue = DispatchQueue(label: "com.suhail.replay-effect-images")
private let replayQueue = DispatchQueue(label: "com.suhail.replay-effect")
...
final class ReplayEffect: VideoEffect {
    ...
    private func applyTransition(_ input: CIImage?, _ target: CIImage?, _ offset: Double)
        -> CIImage?
    {
