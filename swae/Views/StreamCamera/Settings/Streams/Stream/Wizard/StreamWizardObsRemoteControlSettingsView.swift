...
struct StreamWizardObsRemoteControlSettingsView: View {
    ...
    var body: some View {
        Form {
            Section {
                Toggle(
                    isOn: $createStreamWizard.obsRemoteControlEnabled,
                    label: {
                        Text("Enabled")
                    })
            }
            if createStreamWizard.obsRemoteControlEnabled {
                Section {
                    TextField(
                        "ws://213.33.45.132:4567", text: $createStreamWizard.obsRemoteControlUrl
                    )
                ...
                Section {
                    ...
                    Text(
                        """
                        The name of your BRB scene in OBS. Swae will periodically try to switch \
