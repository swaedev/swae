    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text(
                    """
                    Swae will periodically try to switch to the BRB scene if the stream is \
            ...
            if model.database.showAllSettings {
                Section {
                    ...
                    Text(
                        """
                        Swae will switch to the BRB scene configured above when the current scene's \
                        SRT(LA) or RTMP video source is disconnected. Typically enable when using Swae \
            ...
            Section {
                ...
                Text("The name of the Source in OBS that receives the stream from Swae.")
            }
            if model.database.showAllSettings {
                Section {
                    Toggle(
