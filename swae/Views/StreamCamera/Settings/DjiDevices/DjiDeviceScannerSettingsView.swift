        ...
        Form {
            Section {
                if !model.bluetoothAllowed {
                    ...
                    List {
                        ForEach(
                            djiScanner.discoveredDevices.map { discoveredDevice in
                                InlinePickerItem(
                                    id: discoveredDevice.peripheral.identifier.uuidString,
                                    text: discoveredDevice.peripheral.name
                ...
                Text(
                    ...
                    it via Bluetooth. Make sure the Swae device is relatively near the DJI device. \
