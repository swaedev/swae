        ...
        Section {
            ...
            TextEditNavigationView(
                ...
                footers: [
                    String(
                        localized:
                            "Enter assistant's address and port. For example ws://132.23.43.43:2345."
                    )
                ],
    ...
    var body: some View {
        NavigationLink {
            Form {
                Section {
                    NameEditView(
                        name: $streamer.name, existingNames: remoteControlSettings.streamers)
                }
                Section {
                    Toggle("Enabled", isOn: $streamer.enabled)
                        .onChange(of: streamer.enabled) { _ in
...
struct RemoteControlSettingsView: View {
    ...
    var body: some View {
        Form {
            Section {
                Text("Control and monitor Swae from another device.")
            }
            Section {
                NavigationLink {
            ...
            RemoteControlSettingsStreamerView(
                model: model, streamer: database.remoteControl.streamer)
            Section {
                NavigationLink {
                    Form {
