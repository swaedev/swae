...
private struct ScenesListView: View {
    ...
    var body: some View {
        Section {
            ...
            CreateButtonView {
                let name = makeUniqueName(
                    name: SettingsScene.baseName, existingNames: database.scenes)
...
private struct RemoteSceneView: View {
    ...
    var body: some View {
        Section {
            ...
            Text(
                """
                Widgets in selected scene will be shown on the Swae device the remote control \
    ...
    var body: some View {
        Form {
            ...
            AutoSwitchersSettingsView(
                autoSceneSwitchers: model.database.autoSceneSwitchers, showSelector: true)
