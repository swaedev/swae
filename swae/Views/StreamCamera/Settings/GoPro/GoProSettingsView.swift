    ...
    var body: some View {
        GeometryReader { metrics in
            Form {
                Section {
                    NameEditView(
                        name: $launchLiveStream.name, existingNames: goPro.launchLiveStream)
                }
                Section {
                    Toggle(
                        "HERO 12/13",
...
private struct GoProWifiCredentialsSettingsView: View {
    ...
    private func generate() {
        qrCode = GoPro.generateWifiCredentialsQrCode(
            ssid: wifiCredentials.ssid, password: wifiCredentials.password)
    }
            ...
            Form {
                ...
                Section {
                    ...
                    Text(
                        ...
                        Swae's RTMP server on this device. Select \(String(localized: "Custom")) to \
        ...
        Section {
            ...
            CreateButtonView {
                ...
                rtmpUrl.name = makeUniqueName(
                    name: SettingsGoProRtmpUrl.baseName, existingNames: goPro.rtmpUrls)
