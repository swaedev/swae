            ...
            VStack(alignment: .trailing, spacing: 1) {
                ...
                if show.faceBeauty {
                    if show.faceBeautyShape {
                        FaceViewBeautyShape()
                    } else if show.faceBeautySmooth && model.database.color.space != .appleLog
                        && model.database
                            .debug.metalPetalFilters
                    {
                        FaceViewBeautySmooth()
                    }
                    FaceViewBeautyButtons(
                        show: show, beauty: $settings.showBeauty, height: height())
                }
                HStack {
                    Button {
