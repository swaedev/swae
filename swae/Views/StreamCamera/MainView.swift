...
struct ExitStreamButtonView: View {
    let onExit: () -> Void
...
struct MainView: View {
    ...
    init(
        ...
        self.onExitStream = onExitStream
        ...
        VStack(spacing: 0) {
            ZStack {
                ...
                if model.showingPanel != .none {
                    ...
                    let backgroundColor =
                        model.panelHidden ? model.showingPanel.buttonsBackgroundColor() : .clear
                    PanelButtonsView(backgroundColor: backgroundColor, onExitStream: onExitStream)
                        .padding([.trailing], 10)
                        .padding([.top], -7)
                }
            }
            ...
            if model.showingPanel != .none {
                ZStack {
                    ...
                    if !model.panelHidden {
                        PanelButtonsView(backgroundColor: .clear, onExitStream: onExitStream)
                    }
                }
