...
enum SettingsStreamCodec: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsStreamCodec(rawValue: decoder.singleValueContainer().decode(RawValue.self))
            ?? .h264avc
    }
...
enum SettingsStreamResolution: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsStreamResolution(
                rawValue: decoder.singleValueContainer().decode(RawValue.self)) ?? .r1920x1080
    }
...
enum SettingsStreamProtocol: String, Codable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsStreamProtocol(
                rawValue: decoder.singleValueContainer().decode(RawValue.self)) ?? .rtmp
    }
}
...
enum SettingsCaptureSessionPreset: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsCaptureSessionPreset(
                rawValue: decoder.singleValueContainer()
...
class SettingsStreamMultiStreaming: Codable, ObservableObject {
    ...
    required init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        destinations = container.decode(
            .destinations, [SettingsStreamMultiStreamingDestination].self, [])
    }
...
class SettingsStream: Codable, Identifiable, Equatable, ObservableObject, Named {
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(
            .discordSnapshotWebhookOnlyWhenLive, discordSnapshotWebhookOnlyWhenLive)
        ...
        try container.encode(
            .goLiveNotificationDiscordWebhookUrl, goLiveNotificationDiscordWebhookUrl)
    ...
    required init(from decoder: Decoder) throws {
        ...
        openStreamingPlatformChannelId = container.decode(
            .openStreamingPlatformChannelId, String.self, "")
        ...
        obsBrbSceneVideoSourceBroken = container.decode(
            .obsBrbSceneVideoSourceBroken, Bool.self, false)
        ...
        discordChatBotSnapshotWebhook = container.decode(
            .discordChatBotSnapshotWebhook, String.self, "")
        discordSnapshotWebhookOnlyWhenLive = container.decode(
            .discordSnapshotWebhookOnlyWhenLive, Bool.self, true)
        ...
        captureSessionPresetEnabled = container.decode(
            .captureSessionPresetEnabled, Bool.self, false)
        captureSessionPreset = container.decode(
            .captureSessionPreset, SettingsCaptureSessionPreset.self, .medium)
        ...
        goLiveNotificationDiscordMessage = container.decode(
            .goLiveNotificationDiscordMessage, String.self, "")
        goLiveNotificationDiscordWebhookUrl = container.decode(
            .goLiveNotificationDiscordWebhookUrl, String.self, "")
        multiStreaming = container.decode(
            .multiStreaming, SettingsStreamMultiStreaming.self, .init())
    }
...
enum SettingsSceneCameraPosition: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsSceneCameraPosition(
                rawValue: decoder.singleValueContainer()
...
class SettingsScene: Codable, Identifiable, Equatable, ObservableObject, Named {
    ...
    required init(from decoder: Decoder) throws {
        ...
        videoStabilizationMode = container.decode(
            .videoStabilizationMode, SettingsVideoStabilizationMode.self, .off)
        overrideVideoStabilizationMode = container.decode(
            .overrideVideoStabilizationMode, Bool.self, false)
...
enum SettingsHorizontalAlignment: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsHorizontalAlignment(
                rawValue: decoder.singleValueContainer()
...
class SettingsWidgetText: Codable, ObservableObject {
    ...
    required init(from decoder: Decoder) throws {
        ...
        foregroundColor = container.decode(
            .foregroundColor, RgbColor.self, .init(red: 255, green: 255, blue: 255))
        foregroundColorColor = foregroundColor.color()
        ...
        horizontalAlignment = container.decode(
            .horizontalAlignment, SettingsHorizontalAlignment.self, .leading)
        verticalAlignment = container.decode(
            .verticalAlignment, SettingsVerticalAlignment.self, .top)
...
class SettingsWidgetBrowser: Codable, ObservableObject {
    ...
    @Published var swaeAccess: Bool = false
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(.swaeAccess, swaeAccess)
    }
    ...
    required init(from decoder: Decoder) throws {
        ...
        swaeAccess = container.decode(.swaeAccess, Bool.self, false)
    }
}
...
enum SettingsWidgetAlertPositionType: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsWidgetAlertPositionType(
                rawValue: decoder.singleValueContainer()
...
class SettingsWidgetAlertsAlert: Codable, ObservableObject {
    ...
    required init(from decoder: Decoder) throws {
        ...
        textColor = container.decode(
            .textColor, RgbColor.self, .init(red: 255, green: 255, blue: 255))
        accentColor = container.decode(
            .accentColor, RgbColor.self, .init(red: 0xFD, green: 0xFB, blue: 0x67))
        ...
        textToSpeechLanguageVoices = container.decode(
            .textToSpeechLanguageVoices, [String: String].self, .init())
        positionType = container.decode(.positionType, SettingsWidgetAlertPositionType.self, .scene)
        facePosition = container.decode(
            .facePosition, SettingsWidgetAlertFacePosition.self, .init())
    }
...
enum SettingsWidgetAlertsCheerBitsAlertOperator: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsWidgetAlertsCheerBitsAlertOperator(
                rawValue: decoder.singleValueContainer()
                    .decode(RawValue.self)) ?? .equal
    }
}

let twitchCheerBitsAlertOperators = SettingsWidgetAlertsCheerBitsAlertOperator.allCases.map {
    $0.rawValue
}
...
enum SettingsWidgetAlertsChatBotCommandImageType: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsWidgetAlertsChatBotCommandImageType(
                rawValue: decoder.singleValueContainer()
                    .decode(RawValue.self)) ?? .file
    }
...
class SettingsWidgetVideoSource: Codable, ObservableObject {
    ...
    required init(from decoder: Decoder) throws {
        ...
        cameraPosition = container.decode(
            .cameraPosition, SettingsSceneCameraPosition.self, .screenCapture)
        backCameraId = container.decode(.backCameraId, String.self, getBestBackCameraId())
        frontCameraId = container.decode(.frontCameraId, String.self, getBestFrontCameraId())
        rtmpCameraId = container.decode(.rtmpCameraId, UUID.self, .init())
        srtlaCameraId = container.decode(.srtlaCameraId, UUID.self, .init())
        ...
        borderColor = container.decode(
            .borderColor, RgbColor.self, .init(red: 0, green: 0, blue: 0))
        borderColorColor = borderColor.color()
    }
...
enum SettingsWidgetScoreboardType: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsWidgetScoreboardType(
                rawValue: decoder.singleValueContainer()
                    .decode(RawValue.self)) ?? .padel
    }
...
class SettingsWidgetScoreboardPlayer: Codable, Identifiable, ObservableObject, Named {
    static let baseName = String(localized: "🇸🇪 Swae")
    var id: UUID = .init()
    @Published var name: String = baseName
...
enum SettingsWidgetPadelScoreboardGameType: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsWidgetPadelScoreboardGameType(
                rawValue: decoder.singleValueContainer()
                    .decode(RawValue.self)) ?? .doubles
    }
...
enum SettingsWidgetVideoEffectType: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsWidgetVideoEffectType(
                rawValue: decoder.singleValueContainer()
...
enum SettingsWidgetType: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsWidgetType(rawValue: decoder.singleValueContainer().decode(RawValue.self))
            ?? .text
    }
...
class SettingsVideoEffect: Codable, Identifiable, ObservableObject {
    ...
    required init(from decoder: Decoder) throws {
        ...
        removeBackground = container.decode(
            .removeBackground, SettingsVideoEffectRemoveBackground.self, .init())
...
enum SettingsColorSpace: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsColorSpace(rawValue: decoder.singleValueContainer().decode(RawValue.self))
            ?? .srgb
    }
}
...
private let allBundledLuts = [
    ...
    SettingsColorLut(type: .bundled, name: "Swae Meme"),
]
...
enum SettingsVideoStabilizationMode: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsVideoStabilizationMode(
                rawValue: decoder.singleValueContainer()
...
class SettingsChatBotAlias: Codable, ObservableObject, Identifiable {
    ...
    @Published var replacement: String = "!swae"
...
class SettingsChat: Codable, ObservableObject {
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(.textToSpeechEnabled, textToSpeechEnabled)
        try container.encode(
            .textToSpeechDetectLanguagePerMessage, textToSpeechDetectLanguagePerMessage)
    ...
    required init(from decoder: Decoder) throws {
        ...
        usernameColor = container.decode(
            .usernameColor, RgbColor.self, .init(red: 255, green: 163, blue: 0))
        usernameColorColor = usernameColor.color()
        messageColor = container.decode(
            .messageColor, RgbColor.self, .init(red: 255, green: 255, blue: 255))
        messageColorColor = messageColor.color()
        backgroundColor = container.decode(
            .backgroundColor, RgbColor.self, .init(red: 0, green: 0, blue: 0))
        backgroundColorColor = backgroundColor.color()
        backgroundColorEnabled = container.decode(.backgroundColorEnabled, Bool.self, false)
        shadowColor = container.decode(
            .shadowColor, RgbColor.self, .init(red: 0, green: 0, blue: 0))
        ...
        timestampColor = container.decode(
            .timestampColor, RgbColor.self, .init(red: 180, green: 180, blue: 180))
        ...
        textToSpeechDetectLanguagePerMessage = container.decode(
            .textToSpeechDetectLanguagePerMessage, Bool.self, false)
        ...
        textToSpeechLanguageVoices = container.decode(
            .textToSpeechLanguageVoices, [String: String].self, .init())
        textToSpeechSubscribersOnly = container.decode(
            .textToSpeechSubscribersOnly, Bool.self, false)
        ...
        botCommandPermissions = container.decode(
            .botCommandPermissions, SettingsChatBotPermissions.self, .init())
        ...
        showFirstTimeChatterMessage = container.decode(
            .showFirstTimeChatterMessage, Bool.self, true)
        ...
        bottomPoints =
            (try? container.decode(Double.self, forKey: .bottomPoints))
            ?? min(
        ...
        textToSpeechPauseBetweenMessages = container.decode(
            .textToSpeechPauseBetweenMessages, Double.self, 1.0)
        ...
        predefinedMessages = container.decode(
            .predefinedMessages, [SettingsChatPredefinedMessage].self, [])
...
enum SettingsMic: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsMic(rawValue: decoder.singleValueContainer().decode(RawValue.self))
            ?? getDefaultMic()
    }
}
...
enum SettingsLogLevel: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsLogLevel(rawValue: decoder.singleValueContainer().decode(RawValue.self))
            ?? .error
    }
}
...
class SettingsDebugBeautyFilter: Codable, ObservableObject {
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(.showSwae, showSwae)
    ...
    required init(from decoder: Decoder) throws {
        ...
        showSwae = container.decode(.showSwae, Bool.self, false)
...
enum SettingsDnsLookupStrategy: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsDnsLookupStrategy(
                rawValue: decoder.singleValueContainer().decode(RawValue.self)) ?? .system
    }
}
...
enum SettingsSelfieStickButtonFunction: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        do {
            self =
                try SettingsSelfieStickButtonFunction(
                    rawValue: decoder.singleValueContainer()
...
class SettingsSelfieStick: Codable, ObservableObject {
    ...
    required init(from decoder: Decoder) throws {
        ...
        buttonFunction = container.decode(
            .function, SettingsSelfieStickButtonFunction.self, .switchScene)
    }
}
...
class SettingsDebug: Codable, ObservableObject {
    ...
    required init(from decoder: Decoder) throws {
        ...
        maximumBandwidthFollowInput = container.decode(
            .maximumBandwidthFollowInput, Bool.self, true)
        audioOutputToInputChannelsMap = container.decode(
            .audioOutputToInputChannelsMap,
        ...
        beautyFilterSettings = container.decode(
            .beautyFilterSettings, SettingsDebugBeautyFilter.self, .init())
        ...
        dnsLookupStrategy = container.decode(
            .dnsLookupStrategy, SettingsDnsLookupStrategy.self, .system)
...
enum SettingsDjiDeviceImageStabilization: String, CaseIterable, Codable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsDjiDeviceImageStabilization(
                rawValue: decoder.singleValueContainer()
...
enum SettingsDjiDeviceResolution: String, CaseIterable, Codable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsDjiDeviceResolution(
                rawValue: decoder.singleValueContainer()
...
class SettingsDjiDevice: Codable, Identifiable, ObservableObject, Named {
    ...
    required init(from decoder: Decoder) throws {
        ...
        id = container.decode(.id, UUID.self, .init())
        name = container.decode(.name, String.self, Self.baseName)
        bluetoothPeripheralName = try? container.decode(
            String.self, forKey: .bluetoothPeripheralName)
        ...
        imageStabilization = container.decode(
            .imageStabilization, SettingsDjiDeviceImageStabilization.self, .off)
...
enum SettingsGoProLaunchLiveStreamResolution: String, CaseIterable, Codable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsGoProLaunchLiveStreamResolution(
                rawValue: decoder.singleValueContainer()
                    .decode(RawValue.self)) ?? .r1080p
    }
}
...
class SettingsGoProLaunchLiveStream: Codable, Identifiable, ObservableObject, Named {
    ...
    required init(from decoder: Decoder) throws {
        ...
        resolution = container.decode(
            .resolution, SettingsGoProLaunchLiveStreamResolution.self, .r1080p)
    }
}
...
class SettingsGoPro: Codable, ObservableObject {
    ...
    required init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        launchLiveStream = container.decode(
            .launchLiveStream, [SettingsGoProLaunchLiveStream].self, [])
        selectedLaunchLiveStream = try? container.decode(
            UUID.self, forKey: .selectedLaunchLiveStream)
        wifiCredentials = container.decode(
            .wifiCredentials, [SettingsGoProWifiCredentials].self, [])
...
enum SettingsReplaySpeed: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsReplaySpeed(rawValue: decoder.singleValueContainer().decode(RawValue.self))
            ?? .one
    }
...
enum SettingsKeyboardKeyFunction: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsKeyboardKeyFunction(
                rawValue: decoder.singleValueContainer().decode(RawValue.self)) ?? .unused
    }
...
class SettingsRemoteControlServerRelay: Codable, ObservableObject {
    @Published var enabled: Bool = true
    @Published var baseUrl: String = "wss://swae.mys-lang.org/swae-remote-control-relay"
    ...
    required init(from decoder: Decoder) throws {
        ...
        baseUrl = container.decode(
            .baseUrl, String.self, "wss://swae.mys-lang.org/swae-remote-control-relay")
...
enum SettingsSceneSwitchTransition: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsSceneSwitchTransition(
                rawValue: decoder.singleValueContainer().decode(RawValue.self)) ?? .blur
    }
...
enum SettingsExternalDisplayContent: String, Codable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        self =
            try SettingsExternalDisplayContent(
                rawValue: decoder.singleValueContainer().decode(RawValue.self)) ?? .stream
    }
...
class SettingsLocation: Codable, ObservableObject {
    ...
    required init(from decoder: Decoder) throws {
        ...
        desiredAccuracy = container.decode(
            .desiredAccuracy, SettingsLocationDesiredAccuracy.self, .best)
        distanceFilter = container.decode(
            .distanceFilter, SettingsLocationDistanceFilter.self, .none)
    }
}
...
private let allBundledAlertsMediaGalleryImages = [
    SettingsAlertsMediaGalleryItem(name: "Swae pixels"),
    SettingsAlertsMediaGalleryItem(name: "Swae party"),
    SettingsAlertsMediaGalleryItem(name: "Swae trillionaire"),
...
class Database: Codable, ObservableObject {
    ...
    @Published var tapToFocus: Bool = true
    ...
    @Published var mirrorFrontCameraOnStream: Bool = false
    ...
    required init(from decoder: Decoder) throws {
        ...
        networkInterfaceNames = container.decode(
            .networkInterfaceNames, [SettingsNetworkInterfaceName].self, [])
        lowBitrateWarning = container.decode(.lowBitrateWarning, Bool.self, true)
        vibrate = container.decode(.vibrate, Bool.self, false)
        gameControllers = container.decode(
            .gameControllers, [SettingsGameController].self, [.init()])
        remoteControl = container.decode(.remoteControl, SettingsRemoteControl.self, .init())
        startStopRecordingConfirmations = container.decode(
            .startStopRecordingConfirmations, Bool.self, true)
        ...
        streamButtonColor = container.decode(
            .streamButtonColor, RgbColor.self, defaultStreamButtonColor)
        ...
        alertsMediaGallery = container.decode(
            .alertsMediaGallery, SettingsAlertsMediaGallery.self, .init())
        ...
        scoreboardPlayers = container.decode(
            .scoreboardPlayers, [SettingsWidgetScoreboardPlayer].self, .init())
        ...
        sceneSwitchTransition = container.decode(
            .sceneSwitchTransition, SettingsSceneSwitchTransition.self, .blur)
        ...
        externalDisplayContent = container.decode(
            .externalDisplayContent, SettingsExternalDisplayContent.self, .stream)
        cyclingPowerDevices = container.decode(
            .cyclingPowerDevices, SettingsCyclingPowerDevices.self, .init())
        heartRateDevices = container.decode(
            .heartRateDevices, SettingsHeartRateDevices.self, .init())
        phoneCoolerDevices = container.decode(
            .phoneCoolerDevices, SettingsPhoneCoolerDevices.self, .init())
        ...
        autoSceneSwitchers = container.decode(
            .autoSceneSwitchers, SettingsAutoSceneSwitchers.self, .init())
        ...
        disconnectProtection = container.decode(
            .disconnectProtection, SettingsDisconnectProtection.self, .init())
...
final class Settings {
    ...
    private func insertSensitiveData(toDatabase: Database, fromDatabase: Database) {
        for (index, fromStream) in fromDatabase.streams.enumerated()
        where index < toDatabase.streams.count {
    ...
    private func migrateFromOlderVersions() {
        ...
        for widget in realDatabase.widgets where !widget.map.migrated! {
            ...
            let stream =
                realDatabase.streams.first(where: { $0.enabled }) ?? SettingsStream(name: "")
            if widget.type == .map {
                for scene in realDatabase.scenes {
                    for sceneWidget in scene.widgets where sceneWidget.widgetId == widget.id {
                        ...
                        sceneWidget.width = (100 * Double(widget.map.width) / width).clamped(
                            to: 1...100)
                        sceneWidget.height = (100 * Double(widget.map.height) / height).clamped(
                            to: 1...100)
                    }
                }
            }
